...
#Background Image
bgimg = pygame.image.load("background.jpeg")
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Welcome to Snakes", black, 260, 3)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Press Enter To Continue..... SCORE: " + str(score), white, 100, 300)
            ...
            if abs(snake_x - food_x)<6 and abs(snake_y - food_y)<6:
                ...
                food_y = random.randint(70, screen_height -20)
                snk_length +=5
            ...
            text_screen("Score: " + str(score) + "  HIGHSCORE: "+str(hiscore), green, 5, 5)
